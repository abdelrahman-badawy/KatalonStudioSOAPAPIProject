...
response1 = WS.sendRequest(findTestObject('CountryInfoSoapService/GetCapital', [('CountryISOCode') : CountryCode]))
WS.verifyElementText(response1, 'CapitalCityResponse.CapitalCityResult', Capital)

response2 = WS.sendRequest(findTestObject('CountryInfoSoapService/GetCurrency', [('CountryISOCode') : CountryCode]))
